...
/*
 * Fonte: https://github.com/feelfreelinux/ds18b20.
 *
 * Adapted from Filip Grzywok's code available at the link above. All changes to
 * source code are documented with a "-N" identifier at the end.
 */

#ifndef DS18B20_SETUP_H  // Changed header name -N
...
void ds18b20_task(void *pvParameters);  // Added sensor task -N
